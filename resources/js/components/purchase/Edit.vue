...
<script>
    export default{
        ...
        methods :{
            submit(){
                axios
                .post("/api/purchase/update/"+this.$route.params.id, this.fields)
                .then((response)=>{
                    this.fields = {};
                    this.errors = {};
            ...
            getPurchase(){
                ...
                .then((response)=>{
                    ...
                    this.fields.jot_no = this.purchase_data.jot_no;
                    this.fields.dag_no = this.purchase_data.dag_no;
                    this.fields.plot_no = this.purchase_data.plot_no;
                    this.fields.mowza_id = this.purchase_data.mowja;
                    this.fields.division_id = this.purchase_data.division;
                    this.fields.district_id = this.purchase_data.district;
                    this.fields.thana_id = this.purchase_data.thana;
                    this.fields.union_id = this.purchase_data.union;
                    this.fields.cs = this.purchase_data.cs;
                    this.fields.sa = this.purchase_data.sa;
                    this.fields.rs = this.purchase_data.rs;
                    this.fields.brs = this.purchase_data.brs;
                    this.fields.type_id = this.purchase_data.type;
                    this.fields.east = this.purchase_data.east;
                    this.fields.west = this.purchase_data.west;
                    this.fields.north = this.purchase_data.north;
                    this.fields.south = this.purchase_data.south;
                    this.fields.qty = this.purchase_data.qty;
                    this.fields.unit_price = this.purchase_data.unit_price;
                    this.fields.total_price = this.purchase_data.total_price;
                    this.fields.remaining_qty = this.purchase_data.remaining_qty;
